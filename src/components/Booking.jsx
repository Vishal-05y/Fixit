...
//                     city: user.city,
//                     state: user.state,
//                     service: serviceName,  // ✅ Include service name in booking data
//                 }),
//             });
...
//             {user ? (
//                 user.service ? (
//                     <h1>You cannot book a service</h1>
//                 ) : (
//                     <div className="p-6 rounded-lg mt-6 bg-white w-full max-w-md">
...
const BookingPage = () => {
    ...
    const handleSubmit = async (event) => {
        event.preventDefault();
        if (!user || !selectedDate) return; // ✅ Ensure date is selected
