      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col items-center md:items-start">
          <div className="bg-blue-500 rounded-full p-2">
            <Image src="/engineer.png" alt="FixIt Logo" width={40} height={40} />
          </div>
          <h3 className="text-xl font-bold text-white mt-3">FIXIT</h3>
          <p className="text-sm text-gray-400 mt-1">India's #1 Service Booking Platform</p>
        </div>
        ...
        <div className="flex flex-col items-center md:items-end">
          ...
          <div className="flex gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-pink-600 group transition-colors duration-300"
              aria-label="Instagram"
            >
              <svg className="w-5 h-5 group-hover:bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-500 [&>path]:fill-white" fill="currentColor" viewBox="0 0 24 24">
