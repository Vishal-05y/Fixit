...
const ServiceList = () => {
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-gray-100 dark:bg-gray-800 p-4 transition-colors duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {categories.map((cat) => (
                        <Link key={cat} href={`/homeservices/category/services?category=${encodeURIComponent(cat)}`}>
                            <div className="w-full dark:bg-gray-600 shadow-md rounded-2xl p-4 sm:p-6 text-center transform transition duration-300 hover:scale-105 hover:shadow-lg cursor-pointer flex flex-col h-full">
